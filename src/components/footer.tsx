...
export default function Footer() {
  return (
    <footer className="bg-gray-800 text-gray-300 pt-4 md:pt-16">
      <div className="container mx-auto grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-10 px-4">
        <div className="col-span-2 md:col-span-2 lg:col-span-1">
          <Link href="/" className="flex items-center gap-2 mb-2 md:mb-4">
            <Logo className="h-6 md:h-12 text-white" />
          </Link>
          <p className="text-sm">
      ...
      <div className="mt-6 md:mt-12 py-2 md:py-4 border-t border-gray-700">
